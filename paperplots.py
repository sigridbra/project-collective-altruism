...
multinitfilelist = glob.glob('./data/multiskew*')
multinitraw = []

tmp = np.loadtxt(multinitfilelist[0],delimiter=',')
print ( np.shape(tmp) )
...
f2 = ax.plot(statesstd, color='#ff7f0e', alpha=0.5, label="STD states")
f3 = ax.plot(clustrstd, color='#ff7f0e', linestyle=":", label="STD clusters")
#ax.axhline(y=0.0, color='r', linestyle='-')
ax.set(xlabel='timestep',ylabel='AVG // STD')
