...
if __name__ ==  '__main__': 
    ...
    for v in variables:
        filename = f'test-pu0.05-skew0.1-rd0.25-initsd{v}-3s-1500steps-investigate-bump'
        ...
        args1 = {"continuous": True, "type" : "rand", "d": 5, "initSD": v}
        args2 = {"continuous": True, "type" : "cl", "d": 5, "initSD": v}
        args3 = {"continuous": False, "type" : "rand",  "d": 5, "initSD": v}
        args4 = {"continuous": False, "type" : "cl",  "d": 5, "initSD": v}
        args5 = {"continuous": True, "type" : "sf",  "d": 5, "initSD": v}
        args6 = {"continuous": False, "type" : "sf",  "d": 5, "initSD": v}
        args7 = {"continuous": True, "type" : "grid", "initSD": v}
        ...
        models.drawClusterState(sim1, pltNr=1, step=800, subplot=3)
        models.drawClusterState(sim2, pltNr=2, step=800, subplot=3)
        models.drawClusterState(sim3, pltNr=3)
        models.drawClusterState(sim4, pltNr=4)
        models.drawClusterState(sim7, pltNr=7, step=800, subplot=3)
        models.drawClusterState(sim8, pltNr=8)
        models.drawClusterState(sim1, pltNr=1, step=400, subplot=1)
        models.drawClusterState(sim2, pltNr=2, step=400, subplot=1)
        #models.drawClusterState(sim3, pltNr=3, step=500, subplot=1)
        #models.drawClusterState(sim4, pltNr=4, step=500, subplot=1)
        models.drawClusterState(sim7, pltNr=7, step=400, subplot=1)
        #models.drawClusterState(sim8, pltNr=8, step=500, subplot=1)
        models.drawClusterState(sim1, pltNr=1, step=600, subplot=2)
        models.drawClusterState(sim2, pltNr=2, step=600, subplot=2)
        #models.drawClusterState(sim3, pltNr=3, step=1000, subplot=2)
        #models.drawClusterState(sim4, pltNr=4, step=1000, subplot=2)
        models.drawClusterState(sim7, pltNr=7, step=600, subplot=2)
